...
from TTS.encoder.model.resnet import ResNetSpeakerEncoder
    ...
    def __init__(self, ap, augmentation_config):
        ...
        if "additive" in augmentation_config.keys():
            ...
            if additive_path:
                ...
                for noise in self.additive_noise_config.keys():
                    if isinstance(self.additive_noise_config[noise], dict):
                        self.additive_noise_types.append(noise)
